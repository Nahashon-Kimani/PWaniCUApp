...
public class NewSemesterThemeModel {
    private String semesterVerse, semesterNarration, semesterVersion, semester, year;

    public NewSemesterThemeModel() {
    }

    public NewSemesterThemeModel(String semesterVerse, String semesterNarration, String semesterVersion, String semester, String year) {
