...
import com.peter.activity.BsRegistration;
import com.peter.activity.SocialMedia;
...
import com.peter.homeFragment.Program;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter.addFragment(new Program(), "Program");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.bs_registration:
                startActivity(new Intent(MainActivity.this, BsRegistration.class));
                break;
            case R.id.forum:
